                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="https://pbs.twimg.com/profile_images/1437631089229500420/panTZz-J_400x400.jpg" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <img src="https://pbs.twimg.com/profile_images/1437631089229500420/panTZz-J_400x400.jpg" class="img-circle" alt="User Image">
                                    ...
                                    <p>
                                        ...
                                        ?>
                                        <small>Member since Aug. 2022</small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="https://bcspoint.net/mrkhan/" target="blank" class="btn btn-default btn-flat">Profile</a>
                                    </div>
