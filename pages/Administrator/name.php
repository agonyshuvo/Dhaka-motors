					 ...
					 $con=mysqli_connect('localhost','root','','dhaka_motors');
						...
						if(mysqli_num_rows($result)>0){
							while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)){
								...
								echo "<td><a onclick='javascript:confirmationDelete($(this));return false;' href='delete_name.php?ID=".$row['ID']."'>x</a></td>";
                        ...
                        <form role="form" action="add_name.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-flat btn-block btn-success"
                                    onclick="return confirm('Are you sure want to add?')" name="add" value="Add Name">
                            </div>
