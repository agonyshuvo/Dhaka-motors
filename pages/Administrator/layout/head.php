          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="https://pbs.twimg.com/media/FP12j5CaIAAATnb?format=jpg&name=4096x4096" class="user-image" alt="User Image">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  <img src="https://pbs.twimg.com/media/FP12j5CaIAAATnb?format=jpg&name=4096x4096" class="img-circle" alt="User Image">
